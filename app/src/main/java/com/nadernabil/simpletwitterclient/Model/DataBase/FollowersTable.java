...
public class FollowersTable {
    ...
    public static final String COL_FOLLOWER_HANDLE = "col_follower_handle";
    ...
    public static final String DB_FOLLOWERS  = "CREATE TABLE " + TABLE_FOLLOWER + "(" + COL_FOLLOWER_ID + " INTEGER PRIMARY KEY  , "
            + COL_FOLLOWER_NAME + " TEXT , " + COL_FOLLOWER_HANDLE + " TEXT , " + COL_FOLLOWER_PROFILE_IMAGE + " TEXT , " + COL_FOLLOWER_BG_IMAGE + " TEXT , " + COL_FOLLOWER_BIO + " TEXT , " + COL_FOLLOWER_FOLLOWS + " INTEGER "+ ")";
