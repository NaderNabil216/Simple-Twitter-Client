...
public class TweetsTable {
    ...
    public static final String COL_TWEET_CREATED_AT = " col_tweet_created_at";

    public static final String DB_TWEETS = "CREATE TABLE " + TABLE_TWEETS + "(" + COL_TWEET_ID + " INTEGER PRIMARY KEY , " + COL_TWEET_CONTENT + " TEXT , " + COL_FOLLOWER_ID + " INTEGER ," +COL_TWEET_CREATED_AT+" TEXT "+")";
