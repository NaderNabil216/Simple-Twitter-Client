...
public class UserAccountsTable {
    ...
    public static final String COL_USER_BIO = "col_user_bio";
    ...
    public static final String DB_USER = "CREATE TABLE " + TABLE_USER + "(" + COL_USER_ID + " INTEGER PRIMARY KEY, "
            + COL_USER_NAME + " TEXT, " + COL_USER_HANDLE + " TEXT, "+ COL_USER_BIO + " TEXT, "  + COL_USER_PROFILE_IMAGE + " TEXT, " + COL_USER_BG_IMAGE + " TEXT " + ")";
